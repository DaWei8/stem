...
export class LogicEngine {
  constructor(variables, state) {
    ...
    this.state = state;
    console.warn("LogicBot: Using MOCK LogicEngine because Wasm module is missing. Install wasm-pack and run build-logic.bat.");
  }
...
export default async function init(wasm_url) {
  console.warn(`LogicBot: Mock init called with ${wasm_url}`);
