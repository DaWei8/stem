...
const allPillars = [
  ...
  },
  {
    ...
    modes: ["architect", "design"],
  },
  {
    id: "design",
    name: "Design System",
    icon: Palette,
    description: "Visual tokens",
    modes: ["architect", "design"],
  },
  {
    id: "dataengine",
    name: "System Engine",
    icon: Brain,
    description: "Logic & Schema",
    modes: ["architect", "dev", "design"],
  },
  {
    id: "identity",
    name: "User Types",
...
const secondaryActions = [
  {
    ...
    name: "Docs & Assets",
    icon: FileText,
    description: "Specs & Blueprints",
  },
  {
    id: "audit",
    name: "Security Audit",
    icon: ShieldAlert,
    description: "Threat model & flaws",
  },
  {
    id: "collaborators",
    name: "Collaborators",
...
export function Sidebar() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-white shadow-lg dark:bg-zinc-950 transition-colors duration-300">
