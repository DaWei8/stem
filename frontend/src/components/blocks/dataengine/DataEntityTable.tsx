...
import {
  MoreVertical, Key, Edit3, Trash2, Plus, Database
} from 'lucide-react'
import {
          ...
          <TableBody>
            <AnimatePresence mode="popLayout">
              {filtered.map(table => {
                ...
                return (
                  <motion.tr key={table.id} layout initial={{ opacity: 0 }} animate={{ opacity: 1 }}
            ...
            {filtered.length === 0 && (
              <TableRow className="hover:bg-transparent">
                <TableCell colSpan={5} className="py-20 text-center text-[10px] font-bold text-zinc-400 italic">
