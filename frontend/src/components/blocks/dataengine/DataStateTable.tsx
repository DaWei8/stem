...
export function DataStateTable({
  variables,
  searchQuery,
  orphanIds,
  varSourceMap,
      ...
      <Table>
        <TableHeader>
          <TableRow className="border-zinc-200 dark:border-zinc-800 hover:bg-transparent bg-zinc-50 dark:bg-black/50">
            <TableHead className="text-[10px] font-black text-zinc-400 py-4 pl-6 ">
              Identifier
            </TableHead>
            <TableHead className="text-[10px] font-black text-zinc-400 py-4 ">
              Source
            </TableHead>
            <TableHead className="text-[10px] font-black text-zinc-400 py-4 ">
              Registry UUID
            </TableHead>
            <TableHead className="text-[10px] font-black text-zinc-400 py-4 text-center ">
              Type
            </TableHead>
            <TableHead className="text-[10px] font-black text-zinc-400 py-4 text-center ">
              Scope
        ...
        <TableBody>
                ...
                <motion.tr
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "hover:bg-zinc-50/80 dark:hover:bg-black/40",
                ...
                >
                  <TableCell className="py-3.5 pl-6">
                    <div className="flex flex-col">
                      <span className="text-xs font-black tracking-wider text-black dark:text-white">
                        {v.label}
                      </span>
                      <span className="text-[10px] text-zinc-400 font-medium truncate max-w-[180px] mt-0.5">
                  ...
                  <TableCell className="py-3.5 text-center">
                    <span
                      className={cn(
                        "px-2 py-0.5 text-[9px] font-black tracking-tight border",
                        TYPE_STYLE[v.type] || TYPE_STYLE.string,
                      )}
                    >
                      {v.type}
                    </span>
          ...
          {filtered.length === 0 && (
            <TableRow className="hover:bg-transparent">
              <TableCell
                colSpan={7}
                className="py-20 text-center text-xs font-medium text-zinc-400"
              >
                {searchQuery
                  ? "No variables match your search."
                  : "No variables defined. Add your first data point to begin."}
              </TableCell>
            </TableRow>
          )}
        </TableBody>
