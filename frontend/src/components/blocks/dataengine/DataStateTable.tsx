                  ...
                  <TableCell className="py-3.5 pr-6 text-right" onClick={e => e.stopPropagation()}>
                    <DropdownMenu>
                      <DropdownMenuTrigger render={
                        <Button variant="ghost" className="size-7 p-0 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-none shadow-none opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <DropdownMenuContent align="end" className="bg-white dark:bg-black border-zinc-200 dark:border-zinc-800 rounded-none shadow-xl text-black dark:text-white">
                        <DropdownMenuItem onClick={() => onEdit(v)} className="text-xs font-bold py-2 gap-2 cursor-pointer rounded-none">
                          <Pencil className="size-3" /> Edit
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => onDelete(v.id)} className="text-xs font-bold py-2 gap-2 cursor-pointer text-red-500 rounded-none">
