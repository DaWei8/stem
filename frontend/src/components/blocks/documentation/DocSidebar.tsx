...
export function DocSidebar({
  ...
  return (
    <div className="space-y-8 select-none">
      {/* Main Export Card */}
      <div className="p-6 bg-black dark:bg-white text-white dark:text-black space-y-6 shadow-2xl relative overflow-hidden group border border-zinc-900 dark:border-zinc-100">
      ...
      <div className="p-6 border border-zinc-200 dark:border-zinc-800 space-y-4 bg-zinc-50/50 dark:bg-zinc-950/20">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-black uppercase tracking-wider text-zinc-500">Auto-Maintenance</h3>
        </div>
        <p className="text-[11px] text-zinc-400 dark:text-zinc-600 font-medium leading-relaxed">
          Refresh documentation based on latest architectural mutations.
        </p>
        <Button
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {stats.map((stat, i) => (
            <div
              key={i}
              className="flex items-center justify-between p-3 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black/20 group hover:border-zinc-300 dark:hover:border-zinc-750 transition-colors"
            >
