      ...
      <div className="p-6 rounded-lg border border-purple-500/20 dark:border-purple-500/10 space-y-4 bg-purple-50/5 dark:bg-purple-950/5 shadow-lg shadow-purple-500/5 relative overflow-hidden group">
        ...
        <div className="grid grid-cols-3 gap-2">
          <Button
            ...
            className="bg-zinc-100 w-full hover:bg-zinc-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 text-black dark:text-white border border-zinc-200 dark:border-zinc-800 text-[9px] font-bold py-1.5 h-auto rounded-md uppercase transition-all"
          >
            PRD
          </Button>
          <Button
