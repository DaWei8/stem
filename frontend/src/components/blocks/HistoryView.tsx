...
export function HistoryView() {
  ...
  const filteredLogs = useMemo(() => {
    return logs.filter((log) => {
      ...
      const matchesPart =
        selectedPart === "all" || log.part_affected === selectedPart;
      ...
      <div className="space-y-8 pb-20">
        ...
        <header className="pb-6 border-b border-zinc-200 dark:border-zinc-900 space-y-1">
          ...
          <p className="text-xs text-zinc-400 dark:text-zinc-500 font-medium">
            Chronological system audit trail and collaborator logs
          </p>
        </header>

        {/* Filter Toolbar */}
        <div className="flex flex-col rounded-xl md:flex-row md:items-center justify-between gap-4 p-4 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/40">
        ...
        {/* Activity Logs Feed */}
        <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/40 rounded-xl divide-y divide-zinc-250 dark:divide-zinc-900 overflow-hidden">
          {isLoading ? (
            ...
            <div className="p-20 text-center flex flex-col items-center justify-center gap-2">
              ...
              <h3 className="text-sm font-black text-zinc-400 dark:text-zinc-650 mt-2">
                No logs matched
              </h3>
