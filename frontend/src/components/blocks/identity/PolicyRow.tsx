...
import { Trash2, Link2, Terminal, Cpu, Play } from 'lucide-react'
  ...
  return (
    <div className={cn(
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4">
        ...
        <div className="flex-1 min-w-0 space-y-1.5">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {referencedVars.length > 0 && (
              <span className="inline-flex items-center gap-1 text-[9px] font-bold text-violet-500 bg-violet-500/10 border border-violet-500/20 px-1.5 py-0.5" title="Constraint Lineage">
        ...
        {/* Middle Section: Code/Expression (Truncated preview) */}
