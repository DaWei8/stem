...
export function DesignPreview({ tokens, onClose }: DesignPreviewProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-100 dark:bg-zinc-900">
      {/* ─── Toolbar ──────────────────────────────────── */}
      <div className="flex items-center justify-between px-3 py-2.5 bg-white dark:bg-black border-b border-zinc-200 dark:border-zinc-800">
      ...
      {/* ─── Status Bar ───────────────────────────────── */}
      <div className="flex items-center justify-between px-4 py-1.5 bg-white dark:bg-black border-t border-zinc-200 dark:border-zinc-800">
