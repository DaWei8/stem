...
export function ModeSwitcher() {
  ...
  return (
    <div className="relative w-full mt-1 mb-6">
      <div className="bg-white/80 dark:bg-black/90 border-x border-b border-zinc-200 dark:border-zinc-800/50 p-2 flex items-center rounded-xl mx-1 transition-colors">
          ...
          {modes.map((mode) => {
            ...
            return (
              ...
              >
                ...
                <Icon
                  className={cn(
                    "w-3.5 h-3.5 size-3.5 min-w-3.5 min-h-3.5 relative z-10",
                    isActive
                      ? "text-black dark:text-white"
                      : "text-zinc-400 dark:text-zinc-600 transition-colors duration-300 group-hover:text-black dark:group-hover:text-zinc-300",
                  )}
                />
